...
bool cdr_serialize_livox_ros_driver2__msg__CustomMsg(
  const livox_ros_driver2__msg__CustomMsg * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
  {
  ...
  // Field name: points
  {
    ...
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_livox_ros_driver2__msg__CustomPoint(
        &array_ptr[i], cdr);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_livox_ros_driver2
bool cdr_deserialize_livox_ros_driver2__msg__CustomMsg(
  eprosima::fastcdr::Cdr & cdr,
  livox_ros_driver2__msg__CustomMsg * ros_message)
{
  // Field name: header
  {
  ...
  // Field name: points
  {
    ...
    auto array_ptr = ros_message->points.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_livox_ros_driver2__msg__CustomPoint(cdr, &array_ptr[i]);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_livox_ros_driver2
bool cdr_serialize_key_livox_ros_driver2__msg__CustomMsg(
  const livox_ros_driver2__msg__CustomMsg * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
  ...
  // Field name: points
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_livox_ros_driver2__msg__CustomPoint(
        &array_ptr[i], cdr);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_livox_ros_driver2
size_t get_serialized_size_key_livox_ros_driver2__msg__CustomMsg(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _CustomMsg__ros_msg_type * ros_message = static_cast<const _CustomMsg__ros_msg_type *>(untyped_ros_message);
  ...
  // Field name: points
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_livox_ros_driver2__msg__CustomPoint(
        &array_ptr[index], current_alignment);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_livox_ros_driver2
size_t max_serialized_size_key_livox_ros_driver2__msg__CustomMsg(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Field name: points
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_livox_ros_driver2__msg__CustomPoint(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const livox_ros_driver2__msg__CustomMsg * ros_message = static_cast<const livox_ros_driver2__msg__CustomMsg *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_livox_ros_driver2__msg__CustomMsg(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  livox_ros_driver2__msg__CustomMsg * ros_message = static_cast<livox_ros_driver2__msg__CustomMsg *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_livox_ros_driver2__msg__CustomMsg(cdr, ros_message);
}
