  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: points
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; i++) {
      livox_ros_driver2::msg::typesupport_fastrtps_cpp::cdr_serialize_key(
        ros_message.points[i],
        cdr);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: points
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        livox_ros_driver2::msg::typesupport_fastrtps_cpp::get_serialized_size_key(
        ros_message.points[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: points
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        livox_ros_driver2::msg::typesupport_fastrtps_cpp::max_serialized_size_key_CustomPoint(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
